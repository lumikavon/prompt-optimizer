...
- 🖼️ **图像模式**：文生图（T2I）、图生图（I2I）与多图生图，支持变量感知输入、多列测试变体与参考图风格迁移
...
### 图像模式测试
- 📊 **变量感知输入**：在提示词中定义变量并按次填充，支持自动批量替换与预览
- 🧪 **多列测试变体**：并排运行 2–4 列测试变体（每列可独立选择版本/模型），直接对比生成结果
- 🔍 **分析与评估链路**：支持分析、评估、对比评估和基于评估的智能改写
...
- [x] 桌面应用发布
- [x] MCP服务发布
- [x] 图像生成：文生图（T2I）、图生图（I2I）和多图生图支持
- [x] 图像模式变量感知输入与多列测试变体
